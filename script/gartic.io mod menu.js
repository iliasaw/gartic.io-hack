...
$('#kemlimelistesi').css({"display": "none"});
 ...
 $('#modmenupopUp').append('<div class="content"><button class="close"></button><div class="title"><h3>Mod Menu</h3></div><div class="contentPopup info"></div></div>');
     $('#modmenupopUp .content').append('<a onclick="parent.open(\'\');" style="position:relative;top:70px;width:290px;background-color: rgba(64, 120, 192);" class="loginGoogle"><img src="https://i.imgur.com/HVXUQfZ.png" style="position:relative;left:15px;width:25px;height:25px;"><span>Github source code</span></a>');
         setTimeout(function() {
