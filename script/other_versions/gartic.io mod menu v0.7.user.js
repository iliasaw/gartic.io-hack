...
//$('.mobileHide').html('<div class="list1"></div>');
    ...
    //general <label class="text" style="width: 100%; height: 40px;"><input type="text" placeholder="URL" value=""></label>
...
// if (lang==8){
// //$.getJSON('https://raw.githubusercontent.com/anonimbiri/gartic.io-hack/main/world_list/test.json', function(data) {
// langlist.Cheat_İnjected = "Hile Enjekte Edildi :)";
// langlist.Github_source_code = "Github kaynak kodu";
// langlist.Anti_AFK = "AFK Engelleyici";
// langlist.Auto_Report = "Otomatik Şikayet";
// langlist.Auto_Skip = "Otomatik Geç";
// langlist.Auto_kick = "Otomatik Oy At";
// langlist.Auto_Answer = "Otomatik Bil";
// langlist.Rainbow_Drawing = "Renkli Çizim";
// langlist.Disabled = "Devre Dışı";
// langlist.Enabled = "Etkin";
// //});
...
// langlist.Cheat_İnjected = "Hiylə enjekte edildi :)";
// langlist.Github_source_code = "Github mənbə kodu";
// langlist.Anti_AFK = "AFK bloker";
// langlist.Auto_Report = "Avtomatik Şikayət";
// langlist.Auto_Skip = "Avtomatik Atlama";
// langlist.Auto_kick = "Avtomatik Səs";
// langlist.Auto_Answer = "Avtomatik Bilmək";
// langlist.Rainbow_Drawing = "Rəng Çəkmə";
// langlist.Disabled = "Sifarişdən kənarda";
// langlist.Enabled = "Effektiv";
 
// }
// else{
// langlist.Cheat_İnjected = "Cheat İnjected :)";
// langlist.Github_source_code = "Github source code";
// langlist.Anti_AFK = "Anti AFK";
// langlist.Auto_Report = "Auto Report";
// langlist.Auto_Skip = "Auto Skip";
// langlist.Auto_kick = "Auto Kick";
// langlist.Auto_Answer = "Auto Answer";
// langlist.Rainbow_Drawing = "Rainbow Drawing";
// langlist.Disabled = "Disabled";
// langlist.Enabled = "Enabled";
